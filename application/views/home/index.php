                ...
                <div class="item">
                    ...
                    <div class="owl-caption">
                        <div class="container">
                            <div class="content-block">
                                <h2>
                                    <span class="text-bold">Deo Gratias Polytechnic professor explores</span> <br />
                            ...
                            <div class="row">
                                <div class="col-sm-10 col-xs-9">
                                    ...
                                    <span>
                                        ...
                                        <span class="text-place text-light animated fadeInRight">Deo Gratias Polytechnic Street, Gondomanan, 8993, San Francisco, CA</span>
                                    </span>
                                </div>
        ...
        <div class="alumni-dashboard">
            <div class="container">
                <div class="title title-dashboard type1">
                    <h3 class="heading-light no-margin"> My Deo Gratias Polytechnic Alumni Dashboard </h3>
                </div>
                            ...
                            <div class="post-wrapper">
                                    ...
                                    <div class="post-desc-wrapper">
                                        <div class="post-desc">
                                            <div class="post-title">
                                                <h6 class="heading-regular"><a href="#">New Deo Gratias Polytechnic "Start-Up" in Distrupt 2016</a></h6>
                                            </div>
                                ...
                                <div class="post-item clearfix ">
                                    ...
                                    <div class="post-desc-wrapper">
                                        <div class="post-desc">
                                            <div class="post-title">
                                                <h6 class="heading-regular"><a href="#">Deo Gratias Polytechnic Library Gives Alumni New Access</a></h6>
                                            </div>
                                            <div class="post-excerpt">
                                                <p>Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium.</p>
                                            </div>
                                ...
                                <div class="post-item clearfix ">
                                    ...
                                    <div class="post-desc-wrapper">
                                        <div class="post-desc">
                                            <div class="post-title">
                                                <h6 class="heading-regular"><a href="#">Deo Gratias Polytechnic in Silicon Valley: Family and Finance</a></h6>
                                            </div>
                                            <div class="post-excerpt">
                                                <p>Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium.</p>
                                            </div>
                                ...
                                <div class="list-view">
                                        ...
                                        <div class="date-desc-wrapper">
                                            <div class="date-desc">
                                                ...
                                                <div class="date-excerpt">
                                                    <p>Organizer: Deo Gratias Polytechnic Black Alumni Association</p>
                                                </div>
                                                <div class="place">
                                                    <span class="icon map-icon"></span>
                                    ...
                                    <div class="view-item">
                                        ...
                                        <div class="date-desc-wrapper">
                                            <div class="date-desc">
                                                <div class="date-title">
                                                    <h6 class="heading-regular">Weekend at Deo Gratias Polytechnic Sierra Camp</h6>
                                                </div>
                                                <div class="date-excerpt">
                                                    <p>Organizer: Deo Gratias Polytechnic Black Alumni Association</p>
                                                </div>
                    ...
                    <div class="twitter-content">
                        <div class="twitter-desc">
                            <p class="text-light text-center">“I feel fortunate to be joining my classmates in welcoming the Class of
                                2016 to the Deo Gratias Polytechnic alumni community <a href="#">@Deo Gratias PolytechnicEdu</a> <a href="#">@Deo Gratias PolytechnicEdu</a>“</p>
            ...
            <div class="instagram-feed clearfix">
                ...
                <div class="instagram-feed-user text-center">
                    <div class="user-wrapper">
                        ...
                        <span class="name-user">@Deo Gratias PolytechnicEdu</span>
                    </div>
                </div>
            </div>
        </div>
