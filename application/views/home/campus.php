...
<section class="banner inner-page">
    <div class="banner-img"><img src="<?= base_url("assets/images/banner/ourTeacher-banner.jpg") ?>" alt=""></div>
...
<section class="container" style="padding-top:10px">
    <div class="row">
        <div class="col-md-6">
            ...
            <h5 style="font-weight:900;">Have good communication</h5>
            <p class="text-justify" style="font-size:15px;">
            ...
            <h5 style="font-weight:900;">You need to compromise</h5>
            <p class="text-justify" style="font-size:15px;">
        ...
        <div class="col-md-6">
            <h3 class="text-center"><i class="fa fa-map-marker bg-success" style="color:#fff;width:45px;height:45px;padding:10px;border-radius:100%"></i> Living Off Campus</h3>
            <p class="text-justify" style="font-size:15px;">
                ...
                If you decide you do want to live off campus, there are several ways for you to find a good place to live. Check your college's off-campus housing office, which most schools have, or with local real estate agents. You can also find listings online through various real estate search engines
            </p>
        </div>
        <div class="col-md-6">
            <img src="<?=base_url("assets/images/blog/img1.jpg")?>"
        </div>
    </div>
</section>
