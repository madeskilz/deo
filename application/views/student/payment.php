    ...
    <div class="container">
        ...
        <div class="card">
            <div class="row clearfix body">
                ...
                <?php }
                $i =1;foreach ($payment_type as $type) { ?>
                    <?php if ((($level->current_level == 1) && !$profile->paid_school_fee_1 && $type->level == 1) 
                    || (($level->current_level == 2)&& !$profile->paid_school_fee_2 && $type->level == 2)
                    || (($level->current_level == 3)&& !$profile->paid_school_fee_3 && $type->level == 3)
                    || (($level->current_level == 4)&& !$profile->paid_school_fee_4 && $type->level == 4)) { ?>
